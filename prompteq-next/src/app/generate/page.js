...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col font-['Inter'] w-full min-h-0 bg-[#FAFAFA]">
      ...
      <div className="flex flex-col lg:flex-row w-full h-auto lg:flex-1 overflow-visible lg:overflow-hidden">
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {PLATFORMS.map(p => (
                  <button
                    ...
                    style={{
                      padding: p.icon ? "6px 16px 6px 6px" : "10px 16px", borderRadius: 12, border: `2px solid ${COLORS.navy}`,
